...
(function() {
  ...
  $(document).on('page:change', function() {
    return $('#bill_pos_form #form_submit').click(submit_form);
  });

  submit_form = function() {
    var bill, count, model, sn, type_id;
...
(function() {
  this.submit_item_form = function(sz_nz) {
    var count, done_info, id, info, name, type_id;
    type_id = $('#form_type_id').val();
    count = $('#form_count').val();
    name = $('#form_name').val();
    info = $('#form_info').val();
...
(function() {
  ...
  $(document).ready(function() {
    return $("#new_user input[type='submit']").click(login);
  });

  login = function(event) {
    var errors, form, pass;
    event.preventDefault();
    $("#errors").html("");
    errors = false;
    form = $("#new_user");
    login = form.find("input[name='user[login]']").val();
    if (login === '') {
...
(function() {
  var submit_item_form;

  $(document).on('page:change', function() {
    return $('#sz_item_form #form_submit').click(submit_item_form('sz'));
  });

  submit_item_form = function() {
    var count, done_info, id, info, name, type_id;
    type_id = $('#form_type_id').val();
    count = $('#form_count').val();
    name = $('#form_name').val();
